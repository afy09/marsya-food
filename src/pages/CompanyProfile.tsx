          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <motion.div
              ...
              <motion.h2
                ...
                className="text-4xl md:text-5xl font-black leading-tight mt-6">
                Distributor Makanan
              ...
              <motion.p
                ...
                className="text-gray-600 text-lg leading-relaxed mt-8">
              ...
              <motion.p
                ...
                className="text-gray-600 text-lg leading-relaxed mt-6">
            ...
            <motion.div
              ...
              <motion.div
                ...
                className="absolute -top-6 -left-6 bg-white shadow-2xl px-6 py-5 rounded-3xl z-20 border border-yellow-100">
                <h3 className="text-3xl font-black text-yellow-500">1000+</h3>
